...
public class MusicListPageController {
	...
	@FXML
	private TableView<Music> TableView_musicTable;
	
	@FXML
	private TableColumn<Music, Boolean> TableColumn_Button;
	
	@FXML
	private TableColumn<Music, String> TableColumn_musicTitle;
	
	@FXML
	private TableColumn<Music, String> TableColumn_singer;
	
	@FXML
	private TableColumn<Music, String> TableColumn_albumName;
