...
public class MusicPlayerMainUI extends Application{
	...
	private ArrayList<MyImageList> imageLists;
	...
	public ArrayList<MyMusicList> getMusicLists(){
		return this.musicLists;
	}
	
	public ArrayList<MyMangaList> getMangaLists(){
		return this.mangaLists;
	}
	
	public ArrayList<MyNovelList> getNovelLists(){
		return this.novelLists;
	}
	
	public ArrayList<MyVideoList> getVedioLists(){
		return this.videoLists;
	}
	
	public ArrayList<MyImageList> getImageLists(){
